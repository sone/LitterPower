...
NewTwist(
	...
	const tTwistFlags	kDefFlags		= {false, false, true};
...
TwistPerformStatic(
	...
	objCheby*	me = (objCheby*) iParams[paramMe];
	tTwistFlags	flags;
