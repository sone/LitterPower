/*
	...
	Change History (most recent first):
         ...
         <5>     15–3–06    pc      Add expect message
         <4>     10–2–06    pc      Fix bug in MamaRand() that is causing sequence to converge.
         <3>   10–2–2006    pc      Fix braindead intialization error in MamaNew(). Good thing we
                                    tested this on Max 4.1.
         <2>     10–2–06    pc      Shaved a few more cycles off the MamaRand() function.
                                    Incidentally, this might be a candidate for vectorizing.
         <1>     10–2–06    pc      first checked in.
*/
