/*
	...
	Change History (most recent first):
        ...
        <11>    8–5–2006    pc      Fix name conflict between the global enum Symmetry and the
                                    mapping enum Symmetry (now eMapSym)
        <10>      9–1–06    pc      Update to use LitterAssistResFrag().
         <9>      8–9–04    pc      Fix bug in LitterAssist found by Holland Hopson.
         <8>     10–1–04    pc      Update for modified LitterInit()
         <7>      8–1–04    pc      Update for Windows.
         <6>    6–7–2003    pc      Sort out default range/symmetry.
         <5>    9–4–2003    pc      Add STR# resource for LitterAddClass(). Bump version number.
