/*
	...
	Change History (most recent first):
        ...
        <11>   26–4–2006    pc      Update for new LitterLib organization.
        <10>   23–3–2006    pc      Fix problem with gCommonSym array allocation.
         <9>     26–2–05    pc      Finally kill all references to the legacy <SetUpA4.h> and
                                    <A4Stuff.h> stuff. 
                                    <A4Stuff.h> stuff. 
         <8>     28–1–04    pc      Need to #include <string.h> now that we are abandoning the
                                    micro-stdlib.
         ...
         <4>  30–12–2002    pc      Add object version to IChingInfo()
